...
const calculateBallVelocity = function(power, angle) {
...
Ball.prototype.updatePosition = function(delta) {
    ...
    const ball = this;
    const newPos = this.position.add(this.velocity.multiply(delta));
    ...
    const collision = this.handleCollision(newPos);

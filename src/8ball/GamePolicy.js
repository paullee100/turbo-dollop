...
GamePolicy.prototype.drawScores = function() {
    Canvas.drawText("PLAYER " + (this.turn+1), new Vector2(Game.size.x/2 + 40, 200), new Vector2(150, 0), "#096834", "top", "Impact", "70px");
...
GamePolicy.prototype.checkCollisionValidity = function(ball1, ball2) {
